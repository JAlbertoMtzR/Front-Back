...
<table class="table table-hover" id="tabla_articulos" style="        margin-top: 17px;
">
  ...
  <tbody class="searchable2" style="font-size: 10px" id="myTable">
...
Paginador = function(divPaginador, tabla, tamPagina)
{
    ...
    this.tabla = tabla_articulos;           //la tabla a paginar
