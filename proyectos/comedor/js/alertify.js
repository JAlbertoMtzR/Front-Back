	...
	Alertify = function () {
		...
		dialogs = {
			buttons : {
				...
				submit : "<button type=\"submit\" class=\"btn btn-raised btn-primary\" id=\"alertify-ok\" />{{ok}}</button>",
				ok     : "<a href=\"#\" class=\"btn btn-raised btn-info\" id=\"alertify-ok\">{{ok}}</a>",
				cancel : "<a href=\"#\" class=\"btn btn-raised btn-warning\" id=\"alertify-cancel\">{{cancel}}</a>"
			},
