  	...
  	<div class="input-group"> <span class="input-group-addon">Buscar articulo</span>
        ...
        <div class="col-lg-4">
        	<form class="form-form" id="frmAlta" method="POST">
              <h1 class="h1-form">Nuevo correo</h1>
              <input class="input-form" name="modo" id="modo" value="0" type="hidden"/>
              <input class="input-form" name="idu" id="idu" value="0" type="hidden"/>
              <input class="input-form" id="nombre" name="nombre" placeholder="Correo" type="text" />
              <input class="input-form" id="pass" name="pass" placeholder="Contraseña" type="text" />
              <?php echo get_select_dom(); ?>
   ...
   $('#frmAlta').bootstrapValidator({
              ...
              fields: {
                  ...
                  pass: {
                      validators: {
                          notEmpty: {
                              message: '<h4 style="color:red;font-weight:bold;">La contraseña es obligatorio</h4>'
                          }
                      } 
                  },
                  dom: {
                      validators: {
                          notEmpty: {
                              message: '<h4 style="color:red;font-weight:bold;">El Dominio es obligatorio</h4>'
                          }
                      }
                  },
